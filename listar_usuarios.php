                        ...
                        <tbody>
                            <?php foreach ($convert_fetch as $datos) { ?>
                                <tr>
                                    ...
                                    <td><a href="eliminar_usuarios.php?id=<?php echo $datos['id_users'] ?>" class="btn btn-danger">Eliminar</a>
                                        <a href="editar_usuarios.php?id=<?php echo $datos['id_users'] ?>" class="btn btn-warning">Editar</a>
                                </tr>
                            <?php } ?>
                        </tbody>
                    </table>
